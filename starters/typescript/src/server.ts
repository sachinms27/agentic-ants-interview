...
app.get('/api', (req: Request, res: Response) => {
  res.json({ 
    message: 'Notes API Challenge - TypeScript', 
    endpoints: [
      'GET /api/notes',
      'GET /api/notes/:id',
      'POST /api/notes',
...
// NOTE: This route must come BEFORE /api/notes/:id to avoid conflicts
app.get('/api/notes/search', (req: Request, res: Response) => {
  // TODO: Implement search functionality
  // Query parameters: 
  //   - q: search in title and content (string)
  //   - tag: search for exact tag match (string)
...
app.listen(PORT, () => {
  ...
  console.log(`📝 Notes API Challenge - TypeScript Starter`);
  console.log(`📊 Loaded ${notes.length} test notes`);
  console.log(`🔧 TypeScript provides type safety and better IDE support`);
});